...
import (
	...
	experimentctl "github.com/redskyops/redskyops-controller/redskyctl/internal/experiment"
...
func (o *TrialOptions) generate() error {
	...
	if err := experimentctl.ReadExperiments(o.Filename, o.In, experimentList); err != nil {
		return err
	}
